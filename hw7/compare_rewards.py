...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_trajectories_num", default=None, type=int)
    ...
    for file_name in args.file_names:
        ...
        if args.max_trajectories_num is not None:
            total_rewards = total_rewards[:args.max_trajectories_num]
